...
import 'package:movie_app/page/home_screeen_page/sub_list_home_screen/content_cine.dart';
import 'package:sizer/sizer.dart';
import 'package:webview_flutter/webview_flutter.dart';

class CineChannel extends StatefulWidget {
  const CineChannel({super.key});

  @override
  State<CineChannel> createState() => _CineChannelState();
}

class _CineChannelState extends State<CineChannel> {
